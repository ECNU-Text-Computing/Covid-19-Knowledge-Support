...
class ModelTraining(object):
    ...
    def get_lda_model(self, **kwargs):
        ...
        LDA = models.LdaModel(corpus=corpus, id2word=dictionary, random_state=1,
                              num_topics=kwargs["n_components"])
        topics_list = LDA.print_topics(kwargs["n_components"], show_numbers)
        LDA.save(self.model_root + 'LDA_model_{}_dimension.model'.format(kwargs["n_components"]))
        print("成功存储模型...")
    ...
    def get_w2v_model(self, **kwargs):
        ...
        w2v_model.save(self.model_root + 'w2v_model_{}_epochs.model'.format(kwargs["epochs"]))
